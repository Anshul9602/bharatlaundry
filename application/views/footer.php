<footer class="gap foot no-bottom" style="background-image:url(assets/img/footer.jpg)">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="logo">
          <a href="main">
            <img style="max-width:220px ;" alt="img" src="assets/logo/logos.png">
          </a>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="widget-title w1">
          <h3>Our Services</h3>
          <div class="boder"></div>
            <ul >
            <li><i class="fa-solid fa-angle-right"></i><a href="<?php echo base_url('service')?>">LINEN MANAGEMENT</a></li>
              <li><i class="fa-solid fa-angle-right"></i><a href="<?php echo base_url('service')?>">WASHING SERVICES</a></li>
              <li><i class="fa-solid fa-angle-right"></i><a href="<?php echo base_url('service')?>">CUSTOMIZED SOLUTIONS</a></li>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="widget-title">
          <h3>Contact Info</h3>
          <div class="boder" style="margin-bottom: 15px;"></div>
